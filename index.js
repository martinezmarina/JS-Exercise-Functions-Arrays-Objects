...
*/
function temperatureInF(degree, unitOfMeasure) {
  if(unitOfMeasure === "c" || unitOfMeasure === "C"){
...
function getLastCarInfo(array) {
  const lastCar = array.length - 1;
  return `This is a ${array[lastCar].car_make} ${array[lastCar].car_model}`
}
getLastCarInfo();
// /**
